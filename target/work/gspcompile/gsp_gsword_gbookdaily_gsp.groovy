...
class gsp_gsword_gbookdaily_gsp extends GroovyPage {
public String getGroovyPageFileName() { "/WEB-INF/grails-app/views/gbook/daily.gsp" }
public Object run() {
Writer out = getOut()
...
createTagBody(1, {->
printHtmlPart(24)
invokeTag('render','g',509,['template':("includes/daily")],-1)
printHtmlPart(5)
})
