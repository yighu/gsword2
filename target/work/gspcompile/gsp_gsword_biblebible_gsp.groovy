...
class gsp_gsword_biblebible_gsp extends GroovyPage {
public String getGroovyPageFileName() { "/WEB-INF/grails-app/views/bible/bible.gsp" }
public Object run() {
Writer out = getOut()
...
printHtmlPart(5)
invokeTag('javascript','g',14,['library':("application")],-1)
printHtmlPart(6)
invokeTag('modalIncludes','modalbox',14,[:],-1)
printHtmlPart(7)
invokeTag('javascript','g',15,['library':("prototype")],-1)
printHtmlPart(2)
createTagBody(2, {->
printHtmlPart(8)
...
invokeTag('javascript','g',305,[:],2)
printHtmlPart(6)
})
invokeTag('captureHead','sitemesh',307,[:],1)
printHtmlPart(0)
createTagBody(1, {->
printHtmlPart(15)
invokeTag('render','g',311,['template':("/gbook/includes/searchdlg")],-1)
printHtmlPart(6)
})
