...
class gsp_gsword_translateindex_gsp extends GroovyPage {
public String getGroovyPageFileName() { "/WEB-INF/grails-app/views/translate/index.gsp" }
public Object run() {
Writer out = getOut()
...
createTagBody(1, {->
printHtmlPart(24)
invokeTag('render','g',509,['template':("includes/fileupload")],-1)
printHtmlPart(25)
})
