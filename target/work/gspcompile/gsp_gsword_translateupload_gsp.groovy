...
class gsp_gsword_translateupload_gsp extends GroovyPage {
public String getGroovyPageFileName() { "/WEB-INF/grails-app/views/translate/upload.gsp" }
public Object run() {
Writer out = getOut()
...
invokeTag('captureBody','sitemesh',509,['onload':(tm)],1)
printHtmlPart(25)
}
