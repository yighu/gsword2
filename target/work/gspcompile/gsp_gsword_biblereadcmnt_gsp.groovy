...
class gsp_gsword_biblereadcmnt_gsp extends GroovyPage {
public String getGroovyPageFileName() { "/WEB-INF/grails-app/views/bible/readcmnt.gsp" }
public Object run() {
Writer out = getOut()
...
invokeTag('javascript','g',592,[:],2)
printHtmlPart(2)
})
invokeTag('captureHead','sitemesh',593,[:],1)
printHtmlPart(2)
createTagBody(1, {->
printHtmlPart(30)
expressionOut.print(tt)
...
if(true && (layer==0)) {
printHtmlPart(5)
invokeTag('render','g',602,['template':("includes/vcmnt")],-1)
printHtmlPart(2)
}
printHtmlPart(2)
if(true && (layer==1)) {
printHtmlPart(5)
invokeTag('render','g',604,['template':("includes/cmntbibles")],-1)
printHtmlPart(2)
}
printHtmlPart(2)
if(true && (layer==2)) {
printHtmlPart(5)
invokeTag('render','g',604,['template':("includes/cmntbook")],-1)
printHtmlPart(2)
}
printHtmlPart(2)
if(true && (layer==3)) {
printHtmlPart(5)
invokeTag('render','g',607,['template':("includes/cmntchapter")],-1)
printHtmlPart(2)
}
printHtmlPart(2)
if(true && (layer==4)) {
printHtmlPart(5)
invokeTag('render','g',608,['template':("includes/cmntchapter")],-1)
printHtmlPart(2)
}
printHtmlPart(32)
expressionOut.print(txt)
printHtmlPart(33)
invokeTag('message','g',612,['code':("home")],-1)
printHtmlPart(34)
...
invokeTag('captureBody','sitemesh',618,[:],1)
printHtmlPart(37)
}
