...
class gsp_gsword_bible_includes_cmntbibles_gsp extends GroovyPage {
public String getGroovyPageFileName() { "/WEB-INF/grails-app/views/bible/includes/_cmntbibles.gsp" }
public Object run() {
Writer out = getOut()
